...
import AnimListBtn from './face_animation/AnimListBtn';
import CreateTextAnimation from './face_animation/text_driven_animation/CreateTextAnimation';
...
export default function AvatarFacaAnimationView({...props}) {
    ...
    return (
        <Box sx={{ height: '94.5vh', display: 'flex'}}>
            <Card variant='elevation' sx={{ width: '15%', height: '98%', ml:'1%', mt:'1%', bgcolor: '#5f5f5f', borderRadius: 5 }}>
                ...
                <CardContent>
                    ...
                    <CreateAnimBtn faceAnimData={props.faceAnimData} setFaceAnimData={props.setFaceAnimData}
                        animNameList={animNameList} setAnimNameList={setAnimNameList}
                        audioList={audioList} setAudioList={setAudioList}
                    />
                    <CreateTextAnimation textInput={textInput} setTextInput={setTextInput}
                        faceAnimData={props.faceAnimData} setFaceAnimData={props.setFaceAnimData}
                        animNameList={animNameList} setAnimNameList={setAnimNameList}
                        audioList={audioList} setAudioList={setAudioList}
                    />
                    <AnimListBtn animIndex={animIndex} setAnimIndex={setAnimIndex} 
                        animNameList={animNameList} setAnimNameList={setAnimNameList}
