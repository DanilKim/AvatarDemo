...
import CreateSMPLBtnViewModel from "./CreateSMPLBtnViewModel";

export default function CreateSMPLBtnView({ ...props }) {
  const { open, handleClickOpen, handleClose } = new CreateSMPLBtnViewModel();
